...
<template>
    ...
    <div class="min-w-[1150px] bg-gray-100 h-full">
        ...
        <div class="flex items-center bg-gray-900 h-[60px] py-2 fixed min-w-[1150px] w-full">
            <div class="flex">
                <Link :href="route('dashboard')" class="h-[50px] text-white p-2 pt-3 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                        <img src="/images/logo/AMAZON_LOGO.png" width="100" alt="">
                </Link>
            </div>
            <div class="h-[50px] text-white p-2 pt-3 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    ...
                    <div v-else class="flex items-center justify-center">
                        ...
                        <div>
                            <div class="text-[13px] text-gray-300 font-extrabold">
                                <div>Hello</div>
                                <div class="text-[15px] text-white -mt-1.5 font-exrtabold">Select your address</div>
                            </div>
                        </div>
                    </div>
            </div>
            <div class="flex grow items-center h-[45px] px-1">
                <div class="flex items-center justify-center bg-gray-100 border-r border-r-gray-300 font-exrtabold text-[11px] text-gray-600 w-[60px] h-[40px] rounded-l-md cursor-pointer">
                    <div class="pt-[3px]">
                        All
                    </div>
            ...
            <div class="flex">
                ...
                <div @mouseenter="accountAndListFunc(true)" @mouseleave="accountAndListFunc(false)" class="h-[50px] opacity-1 p-2 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-center">
                    <div>
                    ...
                    <div v-if="accountAndList" class="bg-white absolute z-50 top-[56px] -ml-[230px] w-[480px] rounded-sm px-6">
                        <div v-if="$page.props.auth.user">
                            ...
                            <div class="flex">
                                ...
                                <div class="w-1/2 mln-5">
                                    <div class="pb-3">
                                        <div class="font-extrabold pt-3">Your Account</div>
                                        <Link :href="route('profile.edit')" class="text-sm block hover:text-red-600 hover:underline pt-3">Account</Link>
                ...
                <Link :href="route('cart.index')" class="relative h-[50px] p-2 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <span class="absolute text-center right-[18px] w-[21px] -top-0 rounded-full text-[20px]">
        ...
        <div class="flex items-center justify-between bg-[#232f3e] h-[38px] fixed z-10 min-w-[1150px] w-full mt-[60px] ">
            <div class="flex">
                <div @click="showMenu = true" class="flex h-[30px] border-[1px] border-[#232f3e] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center jsutify-between px-2">
        ...
        <div class="w-full bf-white mt-10 overflow-x-scroll">
            <div class="mx-w-[1500px] mx-auto">
                <div class="text-[23px] pt-4 font-exrtabold">Recommended based on your shopping trends</div>
                <div class="flex justify-center items-stretch">
                    <div v-for="product in $page.props.random_product" :key="product">
                        ...
                        <Link :href="route('product.index', {id: product.id}) ">
                            <div class="w-[160px] text-[12px] py-2 text-teal-600 font-extrabold hover:text-red-600">
                                {{ product.title.substring(0, 30) }}....
                            </div>                       
                        </Link>
                        <div class="flex justify-start">
                            <div class="text-xs font-extrabold text-red-600 w-full text-left">${{ product.price }}</div>
                            <img src="/images/logo/PRIME_LOGO.png" width="50" alt="">
                        </div>
                    </div>
                    </div>
                </div>
        ...
        <footer class="bg-[#232f3e]">
            ...
            <div class="flex items-stretch justify-between max-w-[1000px] mx-auto p-10 text-white">
                ...
                <ul>
                    ...
                    <li class="hover:underline cursor-pointer">Become an affilate</li>
    ...
    <div v-if="showMenu" :class="[showMenu ? 'animate__animated animate__fadeIn animate__faster' : '']" class="top-0 z-50 fixed w-full h-full bg-black bg-opacity-70">
        <CloseIcon 
                    ...
                    fillColor="#dcdcdc" 
                    class="ml-[270px] mt-2.5 cursor-pointer fixed z-50" />
        <div 
            ...
            <div class="font-extrabold text-[16px] pt-3 pl-6 pr-3 text-black">
                Shop By Department
            </div>
