...
<template>
    ...
    <AuthenticatedLayout>
       ...
       <div class="max-w-[1200px] mx-auto flex gap-4 justify-between">
            ...
            <div>
                <div class="text-lg font-extrabold m-1">
                    About this item
                </div>
                    ...
                    <div class="my-2 mx-3 mb-2">
                        <div class="flex items-center justify-center border-b border-gray-300 pb-1">
                            <Link 
                                    ...
                                    class="flex items-center font-extrabold text-teal-700 hover:text-red-600 cursor-pointer">
                                <MapMarkerOutlineIcon :size="17" /> Delivery to {{ $page.props.auth.user.first_name }} - {{ $page.props.auth.address.postcode }}
                            </Link>
                            <Link v-else :href="route('login')" class="flex items-center font-extrabold text-teal-700 hover:text-red-600 cursor-pointer">
                                SIGN IN
                            </Link>
                        </div>
