...
onMounted(() => {
     stripe = Stripe("pk_test_51MqixLKBQNcMkPEPVfMsSQCSdUDkWjbvaKd6V3kDbtuW25HLjLlEC5AwVntBeiIKRKpSdDmCDYTEzTM6or4o2UUy00wYDgeoC5");
  ...
  stripe
    ...
    .then(function(result) {
      if (result.error) {
        ...
        console.log('success result ', result.paymentIntent.id);
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex max-w-[1250px] mx-auto pt-4">
            <div class="w-8/12">
                <div class="flex items-stretch border-b border-b-gray-300 w-[cacl(100%-100px)] pb-4 pl-4 mb-6">
        ...
        <div class="w-[1200px] mx-auto text-xl font-bold pb-2 underline">Items</div>
            <div class="w-[1200px] mx-auto" v-for="prod in JSON.parse(order.items)" :key="prod">
                <div class="flex items-center py-1">
                    <img :src="prod.image" width="60" class="rounded-md" alt="" />
                    <div class="ml-4">
